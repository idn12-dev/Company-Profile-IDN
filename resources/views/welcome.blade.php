...
<header class="bg-white shadow-md fixed top-0 left-0 w-full z-50">
    <div class="max-w-7xl mx-auto px-12 py-4 flex justify-between items-center">
        ...
        <!-- Button -->
        <a href="#kontak" class="border border-orange-500 text-orange-500 px-4 py-2 rounded-lg font-semibold hover:bg-orange-500 hover:text-white transition duration-300">
            Konsultasi Gratis
        </a>
    </div>
</header>
...
<!-- Hero Section -->
<section id="beranda"
    class="max-w-7xl mx-auto px-12 py-8 md:py-10 mt-4 grid md:grid-cols-2 gap-8 items-center">
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    <a href="https://wa.me/628978475687" 
       class="fixed bottom-14 right-6 bg-green-500 text-white px-4 py-3 rounded-full flex items-center gap-2 shadow-lg hover:bg-green-600 transition">
